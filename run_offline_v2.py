"""
Parallel non-Anthropic pipeline for expanding the AI-vs-physician meta-analysis.
...
Commands:
  ...
  python run_offline_v2.py adjudication_queue
  python run_offline_v2.py all

This workflow writes only to data_v2_offline/.
"""
...
RAW_DIR = Path("data_v2_offline/raw")
EXTRACTED_DIR = Path("data_v2_offline/extracted")
LANES = [
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AI-vs-physician offline expansion pipeline")
